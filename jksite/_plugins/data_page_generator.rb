...
#
# source URL: https://github.com/avillafiorita/jekyll-datapage_gen/blob/master/lib/data_page_generator.rb
# last fetched: 2020-03-17
# modified by dan nguyen
...
# ).downcase.strip.gsub(' ', '-').gsub(/[^\w.-]/, '')
  ...
  class DataPage < Page
    ...
    def initialize(site, base, index_files, dir, data, name, name_expr, template, extension)
      ...
      # DTK self.data['title'] = raw_filename
